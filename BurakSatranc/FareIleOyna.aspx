<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FareIleOyna.aspx.cs" Inherits="BurakSatranc.FareIleOyna" %>
...
<form id="form1" runat="server">
    ...
    <asp:TextBox ID="TextBox2" runat="server" Width="51px"></asp:TextBox>
                <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="Oyna" />
        <br />
