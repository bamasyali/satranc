<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SifreDegistir.aspx.cs" Inherits="BurakSatranc.SifreDegistir" %>
...
<title>Şifre Değiştir <%Response.Write("| "+Session["KullaniciAdi"]); %></title>
<style type="text/css">
<!--
body,td,th {
...
Şifre Değiştirme<br />
Eski Şifre =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:TextBox ID="EskiSifre" runat="server" TextMode="Password"></asp:TextBox>
<br />
Yeni Sifre =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:TextBox ID="Sifre0" runat="server" TextMode="Password"></asp:TextBox>
<br />
Yeni Sifre Tekrar=
<asp:TextBox ID="Sifre1" runat="server" ontextchanged="EskiSifre1_TextChanged" 
