<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YeniUye.aspx.cs" Inherits="BurakSatranc.YeniUye" %>
...
<form id="Form1" runat="server">
 <br />
 <br />
 <asp:Label ID="Label1" runat="server" Text="YENI KULLANICI EKLEME EKRANI"></asp:Label>
    <br />
    <br />
    <asp:Label ID="Label2" runat="server" Text="Kullanıcı Adı :"></asp:Label>
    <asp:TextBox ID="KADI" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="Label3" runat="server" Text="Şifresi:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    <asp:TextBox ID="Sifre0" runat="server"  
     TextMode="Password"></asp:TextBox>
    <br />
    <asp:Label ID="Label4" runat="server" Text="Adı Soyadı"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
 <br />
 <img src="Captcha/JpegImage.aspx"><br />
 Resimdeki Rakamlari Giriniz<br />
 ...
 <asp:Label ID="Label6" runat="server"></asp:Label>
    ...
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        Text="Kullanıcı EKle" Width="143px" />
</form>
...
<div id="apDiv22">
  <div align="center"><a href="/Default.aspx"><img src="Resimler/anamenu.jpg" width="100" height="35" /></a></div>
</div>