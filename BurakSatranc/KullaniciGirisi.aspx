<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciGirisi.aspx.cs" Inherits="BurakSatranc.KullaniciGirisi" %>
...
<title>Kullanıcı Girişi <%Response.Write("| "+Session["KullaniciAdi"]); %></title>
<style type="text/css">
<!--
body,td,th {
...
<form runat="server">
  <p>&nbsp;</p>
  <p><span class="style8">
    <asp:Label ID="girisadi" Text="Kullanıcı Adı:" runat="server" /></span>
    <asp:TextBox ID="KullaniciAdi" runat="server" /></p>
  <p><span class="style8">
    <asp:Label ID="girissifresi" Text="Şifre:" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
    <asp:TextBox ID="Sifre" runat="server" TextMode="Password" />      </p>
  <p>
