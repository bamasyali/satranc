<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasaOlustur.aspx.cs" Inherits="BurakSatranc.MasaOlustur" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Masa Oluştur <%Response.Write("| "+Session["KullaniciAdi"]); %></title>
<style type="text/css">
<!--
body,td,th {
...
<div id="apDiv16">
  <div align="center" class="style8">
    <div align="left">
        <br />
        Hamle&nbsp; (gün)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; Oyun Süresi (gün)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        Rakip<br />
        <asp:TextBox ID="TextBox1" runat="server" Width="91px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" runat="server" Width="91px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ListBox ID="ListBox1" runat="server" Height="63px" 
            style="margin-top: 10px"></asp:ListBox>
&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox1" runat="server" 
            Text="Siyah Oyuncu Olmak İstiyorum" />
        <br />
        <br />
        <asp:CheckBox ID="CheckBox2" runat="server" 
            Text="Uluslararası Oyun Sistemi. Hamle/Gün Süresi için" />
        <br />
        <br />
