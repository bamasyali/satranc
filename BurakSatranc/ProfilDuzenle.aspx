<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfilDuzenle.aspx.cs" Inherits="BurakSatranc.ProfilDuzenle" %>
...
<title>Profil Düzenle <%Response.Write("| "+Session["KullaniciAdi"]); %></title>
<style type="text/css">
<!--
body,td,th {
...
<br />
KullanıcıAdı :
<asp:Label ID="KullanıcıAdı" runat="server" Text="Label"></asp:Label>
<br />
Ad Soyad :
...
<br />
<a href="SifreDegistir.aspx">Şifrenizi Değiştirmek İçin Tıklayın</a>
</form>
